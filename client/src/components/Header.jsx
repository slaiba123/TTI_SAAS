 ...
 const Header = () => {
   ...
   return (
     ...
     >
        ...
        >
            <p className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-neutral-500'>Best text to image generator ✨</p>
        ...
        >Unleash your creativity with AI. Turn your imagination into visual art in seconds – just type, and watch the magic happen.</motion.p>
            <motion.button
        className='sm:text-lg mx-auto text-white bg-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full'
